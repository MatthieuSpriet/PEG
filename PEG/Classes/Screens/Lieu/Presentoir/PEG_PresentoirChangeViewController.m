...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self showPickerChangePresentoir];
...
- (void)showPickerChangePresentoir
{
    ...
    NSArray* v_arrayValueSelected = nil;
    if (self._BeanPresentoir.tYPE) {
        v_arrayValueSelected = [[NSArray alloc] initWithObjects:self._BeanPresentoir.tYPE, nil];       // pm141110 selection courrante = tYPE
    }
    else {
        // original version (showPickerNewPresentoir): on initialise avec le 1er, pas la selection courrante
        v_arrayValueSelected = [[NSArray alloc] initWithObjects:[values2 keyAtIndex:0],nil];
    }
